...
if DeviceType == "Mobile" then
    ...
    ImageLabel.Image = "rbxassetid://130330354241700",
...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." |Slayer Hub - Premium",
    SubTitle = " (https://discord.gg/Jvtf8bzP)", -- discord link
    TabWidth = 160,
